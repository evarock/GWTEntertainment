function GWTClient(){
  ...
  GWTClient.__sendStats = sendStats;
  GWTClient.__moduleName = $intern_4;
  GWTClient.__errFn = null;
  GWTClient.__moduleBase = $intern_6;
  GWTClient.__softPermutationId = $intern_7;
  GWTClient.__computePropValue = null;
  GWTClient.__getPropMap = null;
  GWTClient.__installRunAsyncCode = function(){
  }
  ;
  GWTClient.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  GWTClient.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  GWTClient.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  GWTClient.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[GWTClient.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (GWTClient.__errFn) {
        script.onerror = function(){
          GWTClient.__errFn($intern_4, new Error($intern_21 + code_0));
        }
        ;
      }
  ...
  GWTClient.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  GWTClient.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_19);
    script.language = $intern_20;
  ...
  function processMetas(){
    ...
    GWTClient.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return GWTClient.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    GWTClient.__getPropMap = function(){
      var result = {};
    ...
    ;
    GWTClient.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = GWTClient.__getPropMap;
  ...
  processMetas();
  GWTClient.__moduleBase = computeScriptBase();
